...
const hitButton = document.querySelector(".blackjack__hit-button");
const dealButton = document.querySelector(".blackjack__deal-button");
...
let blackjackGame = {
  'player': {'scoreSpan' : '.player__blackjack-result', 'div': '.player__slot', 'score': 0},
  'dealer': {'scoreSpan' : '.dealer__blackjack-result', 'div': '.dealer__slot', 'score': 0},
...
document.querySelector('.blackjack__stand-button').addEventListener('click', dealerLogic);
...
dealButton.addEventListener("click", () => {
  if (blackjackGame['turnsOver'] === true) {
    ...
    PLAYER['score'] = 0;
    DEALER['score'] = 0;
    document.querySelector('.player__blackjack-result').textContent = 0;
    document.querySelector('.dealer__blackjack-result').textContent = 0;
    document.querySelector('.player__blackjack-result').style.color = '#ffffff';
    document.querySelector('.dealer__blackjack-result').style.color = '#ffffff';
    blackjackGame['turnsOver'] = true;
}
});
