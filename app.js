...
const resetButton = document.querySelector("#blackjack__Reset__button");
...
let blackjackGame = {
    'player': {'scoreSpan' : '#player__blackjack__result', 'div': '#player__box', 'score': 0},
    'dealer': {'scoreSpan' : '#dealer__blackjack__result', 'div': '#dealer__box', 'score': 0},
...
dealButton.addEventListener("click", () => {
  if (blackjackGame['turnsOver'] === true ) {
    blackjackGame['isStand'] == false;
      ...
      playerResult.style.color = '#ffffff'
      dealerResult.style.color = '#ffffff'
